...
public class AppRestaurante {
	...
	public static void main(String[] args) {
		...
		while(continuar == true) {
			System.out.println("\n\nDigite o código do produto e sua quantidade (0 para interromper): ");
		...
		System.out.println("\n\nDigite o código do tipo de pagamento: ");
		...
		System.out.println("\nA mesa com maior valor gasto por pessoa é a mesa " + ((valorPorPessoa1 > valorPorPessoa2) ? mesa1.getNumero() : mesa2.getNumero()));
